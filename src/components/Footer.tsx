    ...
    <footer className="border-t border-border py-12">
      <div className="container mx-auto px-4">
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-10">
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Empowering local skills with AI-driven discovery. Building stronger
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li><a href="#" className="hover:text-primary transition-colors">Join as Provider</a></li>
        ...
        <div className="border-t border-border pt-6 text-center text-sm text-muted-foreground">
          © 2026 SkillKart. All rights reserved. Built with ❤️ for local communities.
        </div>
      </div>
    </footer>
  );
